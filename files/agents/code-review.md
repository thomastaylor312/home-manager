...
1. **Initial Assessment**
   ...
   - Assess the scope of the change and risk level and use the `question` tool to confirm any uncertainties with the developer and confirm that your scope and risk assessment is accurate
...
This section should be iterative throughout your review.
   - Ask probing questions about design decisions using the `question` tool
   - Challenge assumptions and request justification using the `question` tool
